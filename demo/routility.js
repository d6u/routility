(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Routility"] = factory();
	else
		root["Routility"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.start = exports.r = undefined;
	...
	function r(path, name) {
	  ...
	  return { path: path, name: name, children: children };
	}
	
	function generateDescriptions(_ref) {
	  var path = _ref.path;
	  var name = _ref.name;
	  ...
	  try {
	    for (var _iterator = children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      try {
	        for (var _iterator2 = generateDescriptions(child)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	function buildState(parts) {
	  ...
	  for (var i = 0; i < parts.length; i++) {
	    ...
	    var name = _parts$i.handler;
	    var params = _parts$i.params;
	
	    cur[name] = _extends({}, params);
	    cur = cur[name];
	  }
	...
	function start(def) {
	  ...
	  var _ref2$browserHistory = _ref2.browserHistory;
	  var browserHistory = _ref2$browserHistory === undefined ? false : _ref2$browserHistory;
	  ...
	  try {
	    for (var _iterator3 = generateDescriptions(def)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	  ...
	  function getCurrentState(pathname, search) {
	    var parts = router.recognize(pathname + search);
	    return _extends({}, buildState(parts), { queryParams: parts.queryParams });
	  }
	
	  var history = (browserHistory ? _history.createHistory : _history.createHashHistory)();
	
	  var currentState = getCurrentState(browserHistory ? location.pathname : location.hash.slice(1), location.search);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createLocation2 = __webpack_require__(8);
	...
	var _createHashHistory2 = __webpack_require__(23);
	...
	var _useBasename2 = __webpack_require__(25);
	
	var _useBasename3 = _interopRequireDefault(_useBasename2);
	
	exports.useBasename = _useBasename3['default'];
	
	var _useBeforeUnload2 = __webpack_require__(26);
	...
	var _enableBeforeUnload2 = __webpack_require__(30);
	
	var _enableBeforeUnload3 = _interopRequireDefault(_enableBeforeUnload2);
	
	exports.enableBeforeUnload = _enableBeforeUnload3['default'];
	
	var _enableQueries2 = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DOMStateStorage = __webpack_require__(15);
	
	var _createDOMHistory = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload = __webpack_require__(26);
...
;
//# sourceMappingURL=routility.js.map